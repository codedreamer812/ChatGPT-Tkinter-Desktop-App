...
[![GitHub](https://badgen.net/badge/icon/GitHub?icon=github&color=black&label)](https://github.com/codedreamer812)
...
[![Run on Repl.it](https://replit.com/badge/github/codedreamer812/ChatGPT-Tkinter-Desktop-App.git)](https://replit.com/@codedreamer812/ChatGPT-Tkinter-Desktop-App?v=1)
...
1) Clone this repository to your local machine using the following command:
    ```
    git clone https://github.com/codedreamer812/ChatGPT-Tkinter-Desktop-App.git
    ```
    Alternatively, you can download the EXE application from the web application **[Talk to GPT](https://codedreamer812-openai-api-web-apps-home-xbxlm8.streamlit.app/Talk_To_GPT)**.
...
[ChatGPT-Tkinter-Desktop-App-Demo](https://github.com/codedreamer812/ChatGPT-Tkinter-Desktop-App/assets/55864839/089cf277-d42f-4d85-800f-7b75dbc39684)
